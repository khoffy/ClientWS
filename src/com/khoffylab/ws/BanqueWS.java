 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://ws.khoffylab.com/", wsdlLocation = "http://localhost:8686/BanqueWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUEWS_QNAME = new QName("http://ws.khoffylab.com/", "BanqueWS");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://ws.khoffylab.com/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.khoffylab.com/", "BanqueServicePort"), BanqueService.class, features);
    }
