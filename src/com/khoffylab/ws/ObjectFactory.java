 ...
 * generated in the com.khoffylab.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _ListComptesResponse_QNAME = new QName("http://ws.khoffylab.com/", "listComptesResponse");
    private final static QName _ListComptes_QNAME = new QName("http://ws.khoffylab.com/", "listComptes");
    private final static QName _ConversionEuroToDHResponse_QNAME = new QName("http://ws.khoffylab.com/", "ConversionEuroToDHResponse");
    private final static QName _ConversionEuroToDH_QNAME = new QName("http://ws.khoffylab.com/", "ConversionEuroToDH");
    private final static QName _GetCompteResponse_QNAME = new QName("http://ws.khoffylab.com/", "getCompteResponse");
    private final static QName _GetCompte_QNAME = new QName("http://ws.khoffylab.com/", "getCompte");
    private final static QName _Compte_QNAME = new QName("http://ws.khoffylab.com/", "compte");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.khoffylab.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.khoffylab.com/", name = "listComptesResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.khoffylab.com/", name = "listComptes")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.khoffylab.com/", name = "ConversionEuroToDHResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.khoffylab.com/", name = "ConversionEuroToDH")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.khoffylab.com/", name = "getCompteResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.khoffylab.com/", name = "getCompte")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.khoffylab.com/", name = "compte")
